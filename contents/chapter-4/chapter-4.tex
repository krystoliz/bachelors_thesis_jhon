...
Di mode pembelajaran, \textit{head-up display} (HUD) akan memunculkan timer yang menghitung maju untuk menghitung durasi evakuasi dan indikator arah yang menunjukkan arah ke titik \textit{checkpoint} selanjutnya. Tampilan HUD terlihat di Gambar ~\ref{fig:learningmodehud}. Saat pemain tiba di \textit{checkpoint} terakhir, EvacuationCompleteUI akan muncul dan menampilkan durasi evakuasi dan label performa evakuasi berdasarkan durasi yang dicapai. Label performa evakuasi terdiri dari "Excellent" untuk durasi evakuasi kurang dari \textit{Excellent Threshold} untuk level tersebut, "Good" untuk durasi evakuasi kurang dari \textit{Good Threshold} untuk level tersebut, dan "Need Improvement" untuk durasi evakuasi lebih dari \textit{Good Threshold} untuk level tersebut. EvacuationCompleteUI juga memunculkan tombol untuk kembali ke \textit{scene} utama. EvacuationCompleteUI dapat dilihat di Gambar ~\ref{fig:evacuationcompleteui}.
