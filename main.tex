...
\author{JHON SAMUEL KUDADIRI}{22/503772/TK/55066}
% Input the thesis' title
\title{<<JUDUL SKRIPSI>>}
% Program and the head of the program
\program{Teknologi Informasi}{Dr. Ir. Ahmad Nasikun, S.T., M.Sc.}{NIP 111198801201607101}
% Name of department head and NIP
\departmenthead{Ir. Hanung Adi Nugroho, S.T., M.E., Ph.D., IPM.}{<<NIP>>}
\major{Information Engineering}
\yearsubmit{2026}%tahun pendadaran
\examdate{<<Exam date>>}
% Name of thesis supervisors/promotors
\addsupervisor{Dr. Ir. Ahmad Nasikun, S.T., M.Sc.}{NIP 111198801201607101}
\addsupervisor{Prof. Ir. Lukito Edi Nugroho, M.Sc., Ph.D.}{NIP 196603271991031002}
